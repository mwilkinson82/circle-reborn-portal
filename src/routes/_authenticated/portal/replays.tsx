...
import { ArrowUpRight, Clock, PlayCircle, Search } from "lucide-react";
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {replays.map((replay) => (
                <Card key={replay.id} className="overflow-hidden border-hairline">
                  <div className="aspect-video bg-[linear-gradient(135deg,#101216_0%,#20242b_70%,#d4a15e_100%)] text-background flex items-center justify-center">
