    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container-prose py-24 max-w-xl">
        ...
        <p className="mt-4 text-muted-foreground leading-relaxed">
          ConstructLine uses your Circle membership for sign-in. Use the same email and password you set up for the portal.
        </p>
        <div className="mt-8 flex flex-wrap gap-3">
          <Button asChild size="lg"><Link to="/login">Member sign in <ArrowRight className="ml-2 h-4 w-4" /></Link></Button>
          <Button asChild size="lg" variant="ghost"><Link to="/join">Join the Circle</Link></Button>
        </div>
      </main>
      <MarketingFooter />
    </div>
